        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <tr key={book.id} className="border-b dark:border-gray-700">
                      ...
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        ...
                        {openDropdownId === book.id && (
                          <div
                            id={`dropdown-${book.id}`}
                            className="absolute right-0 mt-2 z-10 w-44 bg-white rounded divide-y shadow dark:bg-gray-700 dark:divide-gray-600"
          ...
          >
            ...
            <ul className="inline-flex items-stretch -space-x-px">
              {/* (Pagination links di sini jika ingin diimplementasikan lebih lanjut) */}
            </ul>
          </nav>
        </div>
      </section>
